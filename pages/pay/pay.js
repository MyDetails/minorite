...
const pay = {
                            ...
                            <div v-if="!orderData" class="editor-address-box">
                                ...
                                <Form class="address-form" ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                                    <FormItem prop="defaultAddress" class="select-address">
                                        <Select v-model="formValidate.defaultAddress" placeholder="请选择收货地址"  @on-change="getAddressId">
                                            <Option v-for="item in address_list" :value="item.id" :key="item.id">{{item.address}}</Option>
                                            <Option value="add" style="color:blue">+添加新地址</Option>
                                        </Select>
                                    </FormItem>
                                    <FormItem v-if="editorShow" label="区域选择：" :label-width="100" prop="text">
                                        <div id="example" style="height:34px;">
                                            <select id="prov" v-model="prov" style="float: left;margin-right:15px;background:#f7f9f3;text-indent:0.8em;padding:0 2%;width:80px;">
                                                <option v-for="option in arr" :value="option.name" bindtap="provnm(option.name)" style="width: 140px;text-align: center;">
                                                    {{ option.name }}
                                                </option>
                                            </select>
                                            <select id="city" v-model="city" style="float: left;margin-right:15px;background:#f7f9f3;text-indent:0.8em;padding:0 2%;width:120px;">
                                                <option v-for="option in cityArr" :value="option.name" bindtap="citynm(option.name)" style="width: 140px;text-align: center;">
                                                    {{ option.name }}
                                                </option>
                                            </select>
                                            <select id="district" v-model="district" v-if="district" style="float: left;background:#f7f9f3;text-indent:1em;padding:0 2%;width:120px;">
                                                <option v-for="option in districtArr" :value="option.name" bindtap="districtnm(option.name)" style="width: 140px;text-align: center;">
                                                    {{ option.name }}
                                                </option>
                                            </select>
                                        </div>
                                    </FormItem>
                                    <FormItem v-if="editorShow" class="address-input" label="详细地址：" :label-width="100" prop="address">
                                        <Input v-model="formValidate.address" placeholder=""></Input>
                                    </FormItem>
                                    <FormItem v-if="editorShow" class="abbreviation-input" label="邮政编码：" :label-width="100" prop="abbreviation">
                                        <Input v-model="formValidate.abbreviation" placeholder=""></Input>
                                    </FormItem>
                                    <FormItem v-if="editorShow" class="name-input" label="收货人姓名：" :label-width="120" prop="name">
                                        <Input v-model="formValidate.name" placeholder=""></Input>
                                    </FormItem>
                                    <FormItem v-if="editorShow" class="phone-input" label="手机号码：" :label-width="100" prop="phone">
                                        <Input v-model="formValidate.phone" placeholder=""></Input>
                                    </FormItem>
                                    <FormItem v-if="editorShow" class="comfirm-address">
                                        <Button class="address-btn" type="primary" @click="handleSubmit('formValidate')">确认</Button>
                                    </FormItem>
                                </Form>
                                <div class="line"></div>
                            </div>
                                    ...
                                    <div v-if="!orderData" class="pay-methods-box">
                                        <RadioGroup v-model="payMethod">
                                            ...
                                            <div class="alipay pay-methods">
                                                <img class="pay-logo" src="http://pe1s.static.pdr365.com/minorite/pay/alipay-logo.png" alt="">
                                            </div>
                                            </Radio>
                                            <Radio label="wxpay">
                                            <div class="wechat-pay pay-methods">
                                                <img class="pay-logo" src="http://pe1s.static.pdr365.com/minorite/pay/wechat-pay-logo.png" alt="">
                                            </div>
                                            </Radio>
                                        </RadioGroup>
                                   </div>
                    ...
                    render: (h, params) => {
                        return h(
                            ...
                            [
                                h("img", {
                                    attrs: {
                                        src: "http://pe1d.static.pdr365.com/" + params.row.name.src,
                                        alt: ""
                                    },
                                    style: {
                                        width: "44px",
    ...
    mounted() {
        ...
        //获取支付方式
        let pk_pay_methods = "tcss.third.payway.list";
        let url_pay_methods = appset.domain + "/front/ypc/rt/?" + Date.parse(new Date()) + "&pk=" + pk_pay_methods;
    ...
    methods: {
        ...
        handleSubmit(name) {
            this.$refs[name].validate(valid => {
                if (valid) {
                    let address = encodeURI(this.formValidate.province + this.formValidate.city + this.formValidate.county + this.formValidate.address);
                    let name = encodeURI(this.formValidate.name);
                    let num = this.formValidate.phone;
        ...
        updateCity: function () {
            for (var i in this.arr) {
                ...
                if (obj.name == this.prov) {
                    ...
                    this.formValidate.province = this.prov;
                    break;
                }
            }
        ...
        updateDistrict: function () {
            for (var i in this.cityArr) {
                ...
                if (obj.name == this.city) {
                    ...
                    this.formValidate.city = this.city;
                    break;
                }
            }
    ...
    watch: {
        ...
        district: function () {
            this.formValidate.county = this.district;
        },
    }
